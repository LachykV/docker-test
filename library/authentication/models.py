...
class CustomUser(AbstractBaseUser):
    ...
    def __str__(self):
        ...
        return f"{self.first_name}, {self.last_name}, {self.email}, {self.role}, {self.is_active}, {self.id}, {self.is_staff}, {self.is_superuser}"
    ...
    def has_perm(self, perm, obj=None):
        ...
        return True  # Adjust this based on your permission logic

    def has_module_perms(self, app_label):
        # Check if the user has permissions for the specified app
        return True  # Adjust this based on your app permissions logic
